  ...
  const appearance = useMemo(() => {
    return {
      ...
      elements: {
        ...
        userButtonPopoverActionButton: "rounded-xl !text-on-surface hover:bg-surface-container hover:!text-on-surface dark:hover:bg-surface-container-high",
        userButtonPopoverActionButtonText: "!text-on-surface font-semibold opacity-100",
        userButtonPopoverActionButtonIcon: "!text-on-surface-variant opacity-100",
